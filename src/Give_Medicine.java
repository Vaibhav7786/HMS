...
public class Give_Medicine extends JFrame {
    ...
    static String pid;
    String Med_Name, Patient_name, Med_price;
...
//
//    }
    Give_Medicine(String Patient_name) {
        ...
        jb.setBounds(40, 250, 150, 30);
        f.add(jb);

        JButton back = new JButton("Back");
        back.setBounds(290, 250, 150, 30);
        f.add(back);
...
//      PreparedStatement ps = con.prepareStatement("update  patient_myhms set Med_Type ='"+Med_Name+" where P_Name='"+Patient_name+"'");
//
